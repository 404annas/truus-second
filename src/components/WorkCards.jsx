...
const WorkCards = () => {
    ...
    useLayoutEffect(() => {
        ...
        const handleMouseMove = (e) => {
            mousePositionRef.current = canHover ? { x: e.clientX, y: e.clientY } : { x: 0, y: 0 }
        }
    ...
    return (
        <section className="relative min-h-screen w-full bg-black text-white overflow-hidden px-4 md:px-8 pb-10">
      ...
      {/* <img src={curlyDoodle} alt="" className="absolute left-1/2 -translate-x-1/2 top-8 w-14 md:w-20 pointer-events-none" /> */}
            ...
            <div className="max-w-7xl mx-auto pt-10">
                <h1 className='text-3xl text-center epilogue font-extrabold'>let's take a look <br /> at some stuff!</h1>
                <div
                    ref={containerRef}
                    className="relative min-h-[560px] lg:min-h-[680px] flex flex-col lg:flex-row justify-center items-center -gap-10"
                >
