        ...
        {isOpen && (
          <div className="fixed inset-0 z-[60] flex overflow-hidden">
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="w-1/2 h-full bg-gradient-to-r from-[#04070A] to-[#015696] flex flex-col justify-center pl-[4%] sm:pl-[8%] lg:pl-[10%] pt-20"
            >
            ...
            >
              ...
              <button className="mt-4 lg:mt-6 bg-[#015494] transition-all duration-300 text-white man font-semibold text-[10px] sm:text-sm px-4 sm:px-6 py-3 sm:py-4 rounded-lg cursor-pointer hover:scale-95">
                Chat With Us
              </button>
            </motion.div>
          </div>
