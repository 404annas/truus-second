...
export default function Agency() {
    return (
        <div id="about" data-navbar-theme="light" className='relative flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#015696] to-[#00192b]'>
